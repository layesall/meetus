...
@public_router.post(
    "/cancel",
    response={200: BookingCancelOut},
    summary="Cancel Booking via Token",
)
...
@public_router.get(
    "/{booking_id}/meet-access",
    response={200: MeetAccessOut, 400: MeetAccessOut, 403: MeetAccessOut, 410: MeetAccessOut},
    summary="Check and Retrieve Meet Access",
)
